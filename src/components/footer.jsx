    ...
    return(
            ...
            <div className="flex items-center justify-between w-full">
                ...
                <nav>
                    <div className="grid grid-flow-col gap-4">
                      <Link to="/lucid_website_test" className="hover:text-orange-600 hover: opacity-80 cursor-pointer transition-colors">
        ...
        <footer className="footer sm:footer-horizontal bg-black text-white p-10">
          ...
          <nav className="mx-4 p-2">
            ...
            <Link to="/lucid_website_test" className="hover:text-orange-600 hover: opacity-80 cursor-pointer transition-colors">Pricing</Link>
            <Link to="/lucid_website_test" className="hover:text-orange-600 hover: opacity-80 cursor-pointer transition-colors">How it works</Link>
            <Link to="/Service" className="hover:text-orange-600 hover: opacity-80 cursor-pointer transition-colors">Services</Link>
            <Link to="/lucid_website_test" className="hover:text-orange-600 hover: opacity-80 cursor-pointer transition-colors">Safety</Link>
          </nav>
          <nav className="mx-4 p-2">
            <h6 className="mb-1 uppercase font-semibold text-white">Company</h6>
            <Link to="/lucid_website_test" className="hover:text-orange-600 hover: opacity-80 cursor-pointer transition-colors">About us</Link>
            <Link to="/lucid_website_test" className="hover:text-orange-600 hover: opacity-80 cursor-pointer transition-colors">Contact</Link>
            <Link to="/lucid_website_test" className="hover:text-orange-600 hover: opacity-80 cursor-pointer transition-colors">Jobs</Link>
          ...
          <nav className="mx-4 p-2">
            ...
            <Link to="/lucid_website_test" className="hover:text-orange-600 hover: opacity-80 cursor-pointer transition-colors">Terms of use</Link>
            <Link to="/lucid_website_test" className="hover:text-orange-600 hover: opacity-80 cursor-pointer transition-colors">Privacy policy</Link>
            <Link to="/lucid_website_test" className="hover:text-orange-600 hover: opacity-80 cursor-pointer transition-colors">Cookie policy</Link>
            <div className="mt-12">
